...
function Products() {
    ...
    const handleAddToCart = async (product, action = 'add') => {
        // Mock cart functionality - replace with actual API calls
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-4 items-start lg:items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-3 w-full lg:w-auto">
                        ...
                        <button
                            ...
                            className={`inline-flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-2xl border transition-all duration-200 ${
                                showFilters 
